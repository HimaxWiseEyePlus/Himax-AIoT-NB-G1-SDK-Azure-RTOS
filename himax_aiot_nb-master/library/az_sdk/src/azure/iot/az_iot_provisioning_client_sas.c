    ...
    size_t* out_mqtt_password_length)
{
  ...
  //0308 xprintf("1 mqtt_password_span %s\n", mqtt_password_span);
  ...
  //0308 xprintf("2 mqtt_password_span %s\n", mqtt_password_span);
  _az_RETURN_IF_FAILED(_az_span_copy_url_encode(
      mqtt_password_span, client->_internal.registration_id, &mqtt_password_span));
  //0308 xprintf("3 mqtt_password_span %s\n", mqtt_password_span);
  // Signature
  ...
  result = _az_span_copy_url_encode(mqtt_password_span, base64_hmac_sha256_signature, &mqtt_password_span);
  //0308 printf("4 mqtt_password_span %s\n", mqtt_password_span);
  //return AZ_OK;
  // Expiration
  ...
  //xprintf("5 mqtt_password_span %s\n", mqtt_password_span);
