...
#define SPI_SLV_DFS_DEFAULT				8		/*!< Default spi slave data frame size */
#define SPI_SLV_NOT_SELECTED			(0xFF)		/*!< Slave is not selected */
#define SPI_SLV_DUMMY_DEFAULT			(0xFF)		/*!< default dummy value for first open */
