...
volatile ULONG      _tx_timer_system_clock __attribute__((section(".sdata")));


/* Define the time-slice expiration flag.  This is used to indicate that a time-slice
   has happened.  */

UINT                _tx_timer_expired_time_slice __attribute__((section(".sdata")));
...
TX_TIMER_INTERNAL   **_tx_timer_list_start __attribute__((section(".sdata")));
TX_TIMER_INTERNAL   **_tx_timer_list_end __attribute__((section(".sdata")));
...
TX_TIMER_INTERNAL   **_tx_timer_current_ptr __attribute__((section(".sdata")));


/* Define the timer expiration flag.  This is used to indicate that a timer 
   has expired.  */

UINT                _tx_timer_expired __attribute__((section(".sdata")));
...
ULONG               _tx_timer_time_slice __attribute__((section(".sdata")));
