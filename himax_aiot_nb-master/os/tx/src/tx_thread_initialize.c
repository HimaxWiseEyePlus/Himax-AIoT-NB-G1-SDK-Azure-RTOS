...
VOID *          _tx_thread_system_stack_ptr __attribute__((section(".sdata")));
...
TX_THREAD *     _tx_thread_current_ptr __attribute__((section(".sdata")));
...
TX_THREAD *     _tx_thread_execute_ptr __attribute__((section(".sdata")));
...
volatile ULONG  _tx_thread_system_state __attribute__((section(".sdata")))=  TX_INITIALIZE_IN_PROGRESS;
...
volatile UINT   _tx_thread_preempt_disable __attribute__((section(".sdata")));
